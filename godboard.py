...
class Creature_board:
    def __init__(self, surface, creatures):
        self.surface = surface
        self.creatures = creatures

        self.rect = pygame.Rect(255, 6, 280, 242)
    def update(self, creatures):
        self.creatures = creatures
    def draw(self):
        pygame.draw.rect(self.surface, pygame.Color("Cyan"), self.rect, 2)
...
class GodBoard:
    def __init__(self, screen, gods, auctions):
        ...
        self.creature = Creature_board(screen, [])
